...
/**
 * Created by zhipengwu on 17-8-18. mobike竞赛数据特征挖掘
 */
public class FeatureMining {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String header = "userid,bikeid,biketype,year,month,day,dayofweek,hour,minute,start_lat_number,start_lat_decimal,start_lng_number,start_lng_decimal,end_lat_number,end_lat_decimal,end_lng_number,end_lng_decimal";
            fw.append(header + "\n");
            while (lineIterator.hasNext()) {
                ...
                if (split.length == 7) {
                    ...
                    if (starttime.contains(":")) {
                        ...
                        int minuteOfHour = (dateTime.getMinuteOfHour()/30)*30;
//                        int secondOfMinute = dateTime.getSecondOfMinute();
                        ...
                        String format = String.format("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n", split[1], split[2],
                                split[3], year, monthOfYear, dayOfMonth,dayOfWeek, hourOfDay, minuteOfHour,
                                start_lat_double_bean.number, start_lat_double_bean.decimal,
                                start_lng_double_bean.number, start_lng_double_bean.decimal,
                                end_lng_double_bean.decimal);
